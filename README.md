...
Existing features are not discussed here - see original Wiki: [https://code.google.com/p/wsg50-ros-pkg/wiki/wsg_32](https://code.google.com/p/wsg50-ros-pkg/wiki/wsg_32)
...
### Services
See [https://code.google.com/p/wsg50-ros-pkg/wiki/wsg_32](https://code.google.com/p/wsg50-ros-pkg/wiki/wsg_32). Services currently block the reception of state updates.

### Topics
* *~/goal\_position [IN, wsg_32_common/Cmd]*, in modes script, auto_update:<br/>
